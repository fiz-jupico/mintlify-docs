...
## In-person and POS integrations

In-person acceptance uses a terminal or semi-integrated point-of-sale flow that connects to Jupico reporting and payout flows.

These docs do not list the specific POS or terminal systems that Jupico integrates with. Support for a particular POS product changes over time and depends on your program setup. To confirm whether a specific POS or terminal system is supported, planned, or requires a certification effort, contact your Jupico account team with the product name and the merchant use case.
