---
title: "Jupico integration go-live checklist for operations teams"
...
<Accordion title="1. Environment Setup">
  ...
  - Production API credentials generated in Backoffice ([instructions](/api-reference/authentication#manage-api-keys-in-backoffice))
