...
<Steps>
  ...
  <Step title="Submit Payout Instructions">
    Submit the payout details — including how and where the funds should be transferred — using the [Dynamic Payouts API](/api-reference/dynamic-payouts-api/create-a-dynamic-payout).
  </Step>
...
To [void an existing payout instruction](/api-reference/dynamic-payouts-api/void-a-dynamic-payout), include the `payoutId` in your void request.
