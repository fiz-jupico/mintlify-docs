...
- [Create an installment](/api-reference/installments-api/create-an-installment)
- [Delete an installment](/api-reference/installments-api/delete-an-installment)
- [Activate an installment](/api-reference/installments-api/activate-an-installment)
- [Deactivate an installment](/api-reference/installments-api/deactivate-an-installment)
- [Update installment payment token](/api-reference/installments-api/update-installment-payment-token)