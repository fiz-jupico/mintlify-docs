---
title: "API go-live checklist: sandbox to production"
sidebarTitle: "Go-Live Checklist"
description: "Verify credentials, webhooks, error handling, security, and monitoring before switching your Jupico API integration from sandbox to production."
---
...
<Steps>
  <Step title="Sign in to production Backoffice">
    Use your production Backoffice user account.
  </Step>
  <Step title="Create an API key">
    Select **Developer** at the bottom of the left navigation, choose **API Keys**, then select **New API Key** and complete the required fields to generate the key. See [Manage API keys in Backoffice](/api-reference/authentication#manage-api-keys-in-backoffice) for details.
  </Step>
