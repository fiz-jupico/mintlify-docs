---
title: "Jupico API authentication with HTTP Basic credentials"
...
<Note>
  API key management requires a Backoffice user account. New to Jupico? [Contact sales](https://jupico.com/demo/) to set up an account.
</Note>

<Steps>
  <Step title="Open Developer settings">
    Select **Developer** at the bottom of the left navigation.
  </Step>
  <Step title="Go to API Keys">
    Choose **API Keys** from the top navigation to review existing keys.
  </Step>
  <Step title="Create a new key">
    Select **New API Key** in the top right and complete the required fields, including a unique key name.
  </Step>
